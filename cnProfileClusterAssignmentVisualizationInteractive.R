...
for(sample in loaded_samples){
  ...
  #
  cd_local()
  facets_segment_clusters <- retrieveSegtable(sample, dir = "segClusteringResults/prev_run_7_19_2018_2/")
  ...
  #
  cd_local()
  visualizeCNProfile(facets_segment_data = facets_segment_clusters_bed, color_id = component_indices, save = TRUE, saveDir = "./clusterAssignmentVisualization/", saveMeta = paste0("clusterassignment_", sample), title=paste0("CNprep Cluster Assignment for sample=", sample))
}
