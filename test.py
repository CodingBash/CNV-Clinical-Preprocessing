...
model_labels = training_set.copy().iloc[:,1]
...
model_labels = pd.DataFrame(data=training_model_labels_transformed, columns = [labeled_matrix_training_set.columns[label]])
